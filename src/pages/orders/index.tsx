...
export const DashboardPage = (): JSX.Element => (
  <>
    <div className="flex w-full grid grid-cols-6">
            <div className="mtor-orders-list col-span-2 space-y-3 bg-white p-5">
                ...
                <div className="mtor-order-item" style={{ borderTop: '1px solid #E5E7EB'}}>
                    ...
                    <div className="order-client-info flex flex-row justify-between pb-3">
                        <div>
                            <span className="pr-3 text-xs uppercase text-gray-400">client:</span>
                            <span className="client-name text-lg font-semibold">Mohammad Anas Jahjah</span>
                            </div>
